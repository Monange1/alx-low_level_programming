...
OAOAOAvoid print_magic(unsigned char *magic)
OAOAOA{
int i;

OAOAOAprintf("ELF Header:\n");
printf("  Magic:   ");
...
OAOAOAOAOAOA
/**
OAOAOA * print_class - Printf ELF class.
 * @class: ELF file.
 * Return: none.
 */
...
OAOAOAvoid print_data(unsigned char *data)
{
printf("  Data:                              ");
OAOAOA
switch (data[EI_DATA])
...
OBOBOBprintf("UNIX - NetBSD\n");
OBOBOBbreak;
case ELFOSABI_LINUX:
OBOBOBOBOBOBprintf("UNIX - Linux\n");
break;
...
break;
case ELFOSABI_TRU64:
OBOBOBprintf("UNIX - TRU64\n");
break;
case ELFOSABI_ARM:
OBOBOBprintf("ARM\n");
OBOBOBOBOBOBOBOBOBbreak;
case ELFOSABI_STANDALONE:
OBOBOBprintf("Standalone App\n");
break;
default:
printf("<unknown: %x>\n", o_a[EI_OSABI]);
}
...
OBOBOB
OBOBOBvoid print_abi(unsigned char *abi)
{
OBOBOBprintf("  ABI Version:                       %d\n",
abi[EI_ABIVERSION]);
}
...
OBOBOBOBOBOBvoid print_type(unsigned int type, unsigned char *class)
{
OBOBOBif (class[EI_DATA] == ELFDATA2MSB)
type >>= 8;
